...
public class TestGameBoardMem {
    ...
    private IGameBoard IGameBoardFactory(int aRow, int aColumn, int aNumToWin){
        return new GameBoardMem(aRow, aColumn, aNumToWin);
    }
    ...
    @Test
    public void testCheckIfFree_Rows5_Cols5_NumToWin5_TokenAtRow_0_1_2_3_ColToCheck_0_True() {
        //test that checkIfFree works with column that is filled except the final row
        //boundary test
        int ROWS = 5;
        int COLS = 5;
        int NUM_TO_WIN = 5;
